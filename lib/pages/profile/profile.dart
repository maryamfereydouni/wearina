...
class _ProfileState extends State<Profile> {
  ...
  void initState() {
    super.initState();
    cont = PageController(viewportFraction: .8);
    cont.addListener(() {
          ...
          child: Stack(children: [
            ...
            Align(
              ...
              child: Hero(
                tag: "tae",
                child: Container(
                  margin: EdgeInsets.only(top: he * .1),
                  width: wi * .3,
                  height: he * .3,
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Color(0xff7c9998).withOpacity(.7),
                        blurRadius: 15,
                        spreadRadius: 1,
                        offset: Offset(2, 2),
                      )
            ...
            Align(
              ...
              child: Container(
                ...
                padding: EdgeInsets.symmetric(
                    horizontal: wi * .025, vertical: wi * .015),
                margin: EdgeInsets.only(top: he * .37),
                decoration: BoxDecoration(
  ...
  buildPage(bool active, int index, var wi, var he) {
    ...
    final Color shadow = active
        ? const Color(0xff7c9998).withOpacity(.5)
